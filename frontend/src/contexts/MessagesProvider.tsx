...
const MessagesContext = createContext(
    {} as MessagesContextState
)
const MessagesContextDispatch = createContext(
    {} as React.Dispatch<MessagesContextAction>
)
// #endregion
...
export default function MessagesProvider({
    children
}: Readonly<MessagesProviderProps>) {
...
function MessagesReducer(
    state: MessagesContextState,
    action: MessagesContextAction
